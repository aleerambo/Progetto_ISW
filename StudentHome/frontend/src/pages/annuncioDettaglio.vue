    ...
    <div v-if="annuncio">
      <div class="card mt-4 shadow-sm">
          ...
          <div class="col-12 col-md-7">
            <div class="card-body">
              ...
              <div class="d-flex flex-column flex-md-row gap-2 mt-3">
                <button 
                  class="btn btn-primary d-flex align-items-center justify-content-center gap-2 fw-bold" 
                ...
                <button 
                  class="btn btn-success d-flex align-items-center justify-content-center gap-2 fw-bold" 
        ...
        <button v-if="user?.ruolo == 'admin'"
          class="btn btn-danger m-3 p-2 position-absolute bottom-0 end-0 p-2 fw-bold" 
